...
public class PedidosService {
	...
	public void nuevoPedido(Pedido pedido) {
		try {
			Files.writeString(pt,u.convertirPedidoACadena(pedido)+System.lineSeparator(),
					StandardOpenOption.APPEND,StandardOpenOption.CREATE);
			System.out.println("Pedido guardado en el fichero.");
		}
		catch(IOException ex) { 
			ex.printStackTrace();
		}
	...
	public Pedido pedidoMasReciente() {
		...
		return pAux;*/
		return Files.lines(pt)   // Stream<Pedido>
